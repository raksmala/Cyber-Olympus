...
Route::get('/laporan/customer/detail/{id}', 'LaporanController@detail')->name('laporan.customer.detail');
Route::get('/laporan/customer/detail-agent/{id}', 'LaporanController@detailAgent')->name('laporan.customer.agent');
...
Route::get('/laporan/item/detail/{id}', 'LaporanController@detailItem')->name('laporan.item.detail');
